...
## Convertir la información de los recuentos a Si o No

El clasificador para el Naive Bayes necesita la información de presencia o ausencia de palabras y no de recuentos. Por eso vamos a construir una nueva matriz que convierta las frecuencias anteriores en factores, de forma que cuando la frecuencia era igual a 0 la nueva matriz mostrará un No, mientras que para una frecuencia diferente de 0, mostrará un Sí. 
...
rv_dtm_train_SN = apply(rv_dtm_train, 2, convert_count)
rv_dtm_train_SN[1:5, 5:10]

rv_dtm_test_SN = apply(rv_dtm_test, 2, convert_count)
```

En estas representaciones de las frecuencias podemos comprobar como ambas matrices coinciden de forma que como hemos dicho antes, los 0 se convierten en No y los 1 se convierten en Sí. 
